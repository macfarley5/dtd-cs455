...
namespace FMOD
{
    ...
    */
    ...
    {
        public const int    number = 0x00040625;
    ...
    */
    public enum INITFLAG
    {
        ...
        OCCLUSION_LOWPASS       = 0x00000008,   /* All platforms - All FMOD_SOFTWARE with FMOD_3D based voices will add a software lowpass filter effect into the DSP chain which is automatically used when Channel::set3DOcclusion is used or the geometry API. */
    ...
    */
    public class ChannelGroup
    {
        ...
        {
            return FMOD_ChannelGroup_OverridePaused(channelgroupraw, (paused ? 1 : 0));
        }
        ...
        {
            return FMOD_ChannelGroup_OverrideMute(channelgroupraw, (mute ? 1 : 0));
        }
    ...
    */
    public class Geometry
    {
        ...
        {
            return FMOD_Geometry_SetPolygonAttributes(geometryraw, polygonIndex, directOcclusion, reverbOcclusion, (doubleSided ? 1 : 0));
        }
        public RESULT getPolygonAttributes	(int polygonIndex, ref float directOcclusion, ref float reverbOcclusion, ref bool doubleSided)
        {
            ...
            result = FMOD_Geometry_GetPolygonAttributes(geometryraw, polygonIndex, ref directOcclusion, ref reverbOcclusion, ref d);
        ...
        [DllImport (VERSION.dll)]
        private static extern RESULT FMOD_Geometry_SetPolygonAttributes (IntPtr geometry, int polygonIndex, float directOcclusion, float reverbOcclusion, int doubleSided);
        [DllImport (VERSION.dll)]
        private static extern RESULT FMOD_Geometry_GetPolygonAttributes (IntPtr geometry, int polygonIndex, ref float directOcclusion, ref float reverbOcclusion, ref int doubleSided);
        [DllImport (VERSION.dll)]
