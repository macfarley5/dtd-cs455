...
namespace TD3d
{
    ...
    {
        public ProjectileBullet(Position pos, Position velocity,ArrayList creeps,GraphicsDeviceManager graphics, ContentManager content, GraphicsDevice device, Creep target, int damage)
        {
            this.target = target;
            this.pos = pos;
            this.creeps = creeps;
